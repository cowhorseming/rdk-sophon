...
| AMD server and performance proof | **Pending owner-supplied evidence** | Radeon GPU, ROCm, vLLM, model precision, and baseline-versus-tuned results must be attached |
